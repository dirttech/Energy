...
public partial class MeterStatus : System.Web.UI.Page
{
    ...
    protected void LastSeenAt(object sender, EventArgs e)
    {
        ...
        FetchEnergyDataS_Map.GetMeterByID(metId,"Faculty Housing","Energy", out val, out time);
        if (time > 0)
        {
            ...
            FetchEnergyDataS_Map.GetMeterByID(metId, "Faculty Housing", "Power", out val2, out time);
