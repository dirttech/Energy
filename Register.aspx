            ...
            <td style="vertical-align: top;">
                <div class="LoginContainer">
                    <div class="login">
                        ...
                        <p>
                            <asp:TextBox type="text" name="email" Text=""
                        ...
                        <p>
                            <input type="text" name="contactNo" value="" placeholder="Contact No (In case we need to contact you)" runat="server" id="contactNo" />
                        </p>
                        <p class="submit">
                            <asp:Button ID="registerUser" runat="server" Text="Register"
                                OnClick="registerUser_Click" />
                        </p>
                        <p>
