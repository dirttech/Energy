<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GirlsHostelMeterStatus.aspx.cs" Inherits="MeterStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="text-align: right; margin-right: 100px;">
        <asp:Button ID="Button1" runat="server" Text="Refresh"
            OnClick="Button1_Click" Width="110px" Height="25px" />
    </div>
    ...
    <asp:UpdatePanel ID="updt" runat="server" class="updt">
        ...
        <ContentTemplate>
            ...
            <div id="duplicate" runat="server" class="duplicate">
                <img src="images/loader.gif" height="20px" />
                Loading...
            </div>
