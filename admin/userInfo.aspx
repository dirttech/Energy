...
<label id="subHeading" runat="server" style="font-size:small; " ></label>
   ...
   <li><a class="navy" onclick="pageLoad('CreateUser.aspx')">Create User</a></li>
    <li><a class="navy" onclick="pageLoad('AssignMeter.aspx')" >Assign Meter</a></li>
    <li><a class="navy" onclick="pageLoad('ChangeMeter.aspx')" >Change Meter</a></li>
    ...
    <td style="vertical-align:top; margin-top:0px; padding-top:0px;">
       <iframe id="sideFrame" style="border:none; height:600px;  width:700px; overflow:visible;"></iframe>
    </td>
    </tr>
    </table>
