<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignMeter.aspx.cs" Inherits="CreateMapUser" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Assign Meter/Device ID's</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <input type="hidden" runat="server" id="hiddenUser" />
    ...
    <div class="HeadingLeftTop" style="background-color:White;" >
                <asp:Label ID="Top2" runat="server" Font-Bold="False" style="font-size:large; color:#265D85; line-height:19px;" >Assign Meter</asp:Label>
    ...
    <asp:TextBox ID="apartmentText" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ControlToValidate="apartmentText" Display="Dynamic" ErrorMessage="*Required" 
