...
public partial class MeterStatus : System.Web.UI.Page
{
    ...
    protected void LastSeenAt(object sender, EventArgs e)
    {
        ...
        FetchEnergyDataS_Map.GetMeterByID(metId, "Boys Hostel", "Energy", out val, out time);
        if (time > 0)
        {
            ...
            FetchEnergyDataS_Map.GetMeterByID(metId, "Boys Hostel", "Power", out val2, out time);
